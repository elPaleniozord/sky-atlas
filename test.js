...
d3.json("https://gist.githubusercontent.com/djdmsr/e7179cd81961200ee5c39c2c8c3e1ac6/raw/231765dc684864b1552065f320282c62a8fa7921/stars", function(error, data) {
    ...
    var starsMag = [] // store stars magnitude
    data = data.map(function(constellation) {                                   //data = json data,
        constellation.stars = constellation.stars.filter(function(star) {       //filter stars that have magnitude greater than 6 store them in starsMag
